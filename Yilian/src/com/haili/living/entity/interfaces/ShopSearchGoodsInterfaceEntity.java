...
/**
 * Created by liteng on 2015/4/27. 生活馆搜索商品接口类
 */

public class ShopSearchGoodsInterfaceEntity {

//	public ShopSearchGoodsInterfaceEntity(@JsonProperty("datas") T datas) {
//		this.datas = datas;
//	}

	public ShopSearchGoodsInterfaceEntity() {
	}
	/**
	 * datas : [{"gc_id":"1217","goods_price":"11.00","farm_type":null,
	 * "goods_commonid"
	 * :"20","goods_id":"43","store_id":"11","goods_name":"测试生活馆2"
	 * ,"goods_image":
	 * "http://www.zq2014.com/haili/data/upload/shop/store/goods/11/11_04805073382771374_360.jpg"
	 * ,"store_name":"生活馆大学城店"}] result : 1 page_total : 1 code : 200 hasmore :
	 * false
	 */
