...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private boolean showDivder = true;
	...
	private void addTextTab(final int position, String title,String subTitle) {
		...
		TextView subTab = new TextView(getContext());
		subTab.setText(subTitle);
		subTab.setGravity(Gravity.CENTER);
		subTab.setSingleLine();
		
		tabLayout.addView(tab);
		tabLayout.addView(subTab);
