 ...
 */
public class LivingSearchItemAdapter extends BaseAdapter {
	protected LoadNetworkPic imageLoader;
	private Context mContext;
	private LayoutInflater layoutInflater;
	private List<GoodForSearchEntity> list;
	private DecimalFormat df;

	public LivingSearchItemAdapter(Context mContext, List<GoodForSearchEntity> voList) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
	    ...
	    imageLoader.DisplayImage(list.get(position).getGoods_image(), holder.goods_icon);
